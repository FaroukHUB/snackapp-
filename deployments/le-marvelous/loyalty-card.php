...
$restaurantConfig = [];
if (file_exists($configDir . 'restaurant.json')) {
    $restaurantConfig = json_decode(file_get_contents($configDir . 'restaurant.json'), true) ?: [];
}

$restaurantName = $restaurantConfig['name'] ?? 'Le Marvelous';
$primaryColor = $restaurantConfig['theme']['primary'] ?? $restaurantConfig['branding']['primaryColor'] ?? '#2ec4b6';
...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="template-v2/css/style.css">
...
<body>
    <div class="page-container">
        <header class="page-header">
            <a href="template-v2/fidelite.html" class="back-btn">
        ...
        <section class="results-section" id="resultsSection">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">DA Depenses</div>
                </div>
            </div>
                ...
                <div id="rewardsList">
                    <div class="reward-item">
                        ...
                        <div class="reward-info">
                            <div class="reward-name">Cookie offert</div>
                            <div class="reward-points">500 points requis</div>
                        </div>
                        <span class="reward-status locked" data-points="500">Verrouille</span>
                    </div>
                    <div class="reward-item">
                        <div class="reward-icon">🥤</div>
                        <div class="reward-info">
                            <div class="reward-name">Boisson offerte</div>
                            <div class="reward-points">800 points requis</div>
                        </div>
                        <span class="reward-status locked" data-points="800">Verrouille</span>
                    </div>
                    <div class="reward-item">
                        <div class="reward-icon">🥞</div>
                        <div class="reward-info">
                            <div class="reward-name">Crepe offerte</div>
                            <div class="reward-points">1500 points requis</div>
                        </div>
                        <span class="reward-status locked" data-points="1500">Verrouille</span>
                    </div>
                </div>
            </div>
        ...
        <!-- Back to Menu -->
        <a href="template-v2/index.html" class="menu-btn">
